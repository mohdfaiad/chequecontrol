...
uses
  ...
  frxExportPDF, frxExportXLS, UIT_UTILS_LIB, SearchBar;
...
type
  TQ001FrmRequest = class(TfrmBase)
    ...
    procedure G1Ac_statusGetDisplayText(Sender: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; var AText: string);
    ...
    procedure G2Column_amtGetDisplayText(Sender: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord; var AText: string);
    procedure gdbtvSearchListColumn6GetDisplayText(
      Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
      var AText: string);
    procedure gdbtvSearchListColumn12GetDisplayText(
      Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
      var AText: string);
    procedure gdbtvSearchListColumn14GetDisplayText(
      Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
      var AText: string);
...
procedure TQ001FrmRequest.gdbtvSearchListColumn12GetDisplayText(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AText: string);
begin
...
procedure TQ001FrmRequest.gdbtvSearchListColumn14GetDisplayText(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AText: string);
begin
  inherited;
...
procedure TQ001FrmRequest.gdbtvSearchListColumn6GetDisplayText(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AText: string);
begin
  inherited;
  AText := gdbtvSearchListColumn18.DataBinding.Field.DisplayText;
end;

procedure TQ001FrmRequest.G1Ac_statusGetDisplayText(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AText: string);
begin
  inherited;
  AText := DataSource2.DataSet.FieldByName('CQTACT').AsString + DataSource2.DataSet.FieldByName('CQTSTS').AsString;
end;
...
//  StrSql := 'Select * From vChequeInfo #';
 {   StrSql := ' SELECT A.* ,B.CQMNAT , '+
    ...
    StrSql := 'SELECT 0 AS CHK, A.CQMNO2, A.CQMAMT, a.CQMDAT, a.CQMTRD       '+
              ' ,  a.CQMCTY   '+
...
//  end;
  ...
  begin
//   if UpperCase(Sarr[i]) <> 'CQMSTA' then
       ff[i] := Sarr[i];
  end;

  for I := 0 to High(ff) do
  begin
//  ShowMessage(sarr[i]);
    S2Arr := FStrSQL(StrSql ,ff );
//    ShowMessage(S2Arr[i]);
